...
In the brainstorming-phase we thought our project very small\
...
For an easy read, we did not include any get-funktion nor parameter for any funktion nor connections between the logic classes
